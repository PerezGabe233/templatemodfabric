...
import gabe.templatemod.TemplateMod;
...
public class ModItems {
    ...
    public static final Item CITRINE_SWORD = registerItem("citrine_sword", new CitrineSword(new FabricItemSettings()));
    ...
    public static void addItemsToItemGroup() {
        ...
        addToItemGroup(ItemGroups.COMBAT, CITRINE_SWORD);
    }
